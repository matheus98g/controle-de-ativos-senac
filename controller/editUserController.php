...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($db, $updateQuery)) {
        ...
        echo "<script>alert('Usuário atualizado com sucesso'); window.location.href = '../view/list_users.php';</script>";
    } else {
        // Caso ocorra um erro
        echo "<script>alert('Erro ao atualizar usuário'); window.location.href = '../view/list_users.php';</script>";
    }
}
